...
const HeroSection = () => {
 ...
 <div className='herocontent' >
      ...
      <div className="text-white max-w-md mx-auto px-6 absolute top-25">
  {/* Heading */}
  <p className="font-bold  sm:text-4xl leading-tight mb-4 herohead">
    Premium Packed Powdered Coffee
  </p>
  
  {/* Subheading */}
  <p className=" sm:text-xl mb-6 leading-relaxed text-[#AD7C59] heroet">
    From the birthplace of coffee, Ethiopia, we bring you rich, flavorful coffee packed for convenience and freshness.
  </p>
  
  {/* Description */}
  <p className=" sm:text-xl leading-relaxed mb-8 text-gray-300 herodesc">
    Discover the essence of Ethiopian coffee with every cup — a tradition of deep roots and bold flavors.
  </p>
  
  <a href="#" className="herobutton bg-[#61300D] hover:bg-[#AD7C59] text-white rounded-lg text-lg transform transition-all duration-300 hover:translate-x-4 ">
  Discover Our Coffee
</a>
      ...
      <div className='icons absolute top-95'>
        <svg className="w-4 h-6 text-white mb-2 cursor-pointer" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
